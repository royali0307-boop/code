window.translations = {
    en: {
        ...
        personalityTest: 'MBTI Personality Test', personalityTestDesc: 'Discover your 16 personality types',
        mbtiTitle: '🧠 MBTI Personality Test', mbtiSubtitle: 'Discover your 16 personality types',
        mbtiIntro1: 'The MBTI (Myers-Briggs Type Indicator) is one of the most popular personality tests worldwide. It categorizes personality into 16 types based on four dimensions:',
        mbtiIntro2: 'Answer 12 questions to discover your MBTI type!',
        mbtiStartBtn: 'Start Test', mbtiRestartBtn: 'Take Test Again', mbtiResultTitle: 'Your Personality Type',
    ...
    in: {
        ...
        personalityTest: 'MBTI व्यक्तित्व परीक्षण', personalityTestDesc: 'अपने 16 व्यक्तित्व प्रकार खोजें',
        mbtiTitle: '🧠 MBTI व्यक्तित्व परीक्षण', mbtiSubtitle: 'अपने 16 व्यक्तित्व प्रकार खोजें',
        mbtiIntro1: 'MBTI (मायर्स-ब्रिग्स टाइप इंडिकेटर) दुनिया में सबसे लोकप्रिय व्यक्तित्व परीक्षण है। यह चार आयामों के आधार पर व्यक्तित्व को 16 प्रकारों में वर्गीकृत करता है:',
        mbtiIntro2: 'अपना MBTI प्रकार खोजने के लिए 12 प्रश्नों के उत्तर दें!',
        mbtiStartBtn: 'परीक्षण शुरू करें', mbtiRestartBtn: 'फिर से प्रयास करें', mbtiResultTitle: 'आपका व्यक्तित्व प्रकार',
    ...
    ko: {
        ...
        personalityTest: 'MBTI 성격 검사', personalityTestDesc: '16가지 성격 유형 발견',
        mbtiTitle: '🧠 MBTI 성격 검사', mbtiSubtitle: '16가지 성격 유형 발견',
        mbtiIntro1: 'MBTI(마이어스-브iggs 지표)는 전 세계에서 가장 인기 있는 성격 테스트입니다. 네 가지 차원에 따라 성격을 16가지 유형으로 분류합니다:',
        mbtiIntro2: '12개의 질문에 답변하여 MBTI 유형을 발견하세요!',
        mbtiStartBtn: '테스트 시작', mbtiRestartBtn: '다시 하기', mbtiResultTitle: '당신의 성격 유형',
    ...
    ja: {
        ...
        personalityTest: 'MBTI性格診断', personalityTestDesc: '16タイプの性格を発見',
        mbtiTitle: '🧠 MBTI性格診断', mbtiSubtitle: '16タイプの性格を発見',
        mbtiIntro1: 'MBTI（マイヤーズ・ブリッグス指標）は世界で最も人気の性格テストです。4つの次元に基づいて16のタイプに分類します：',
        mbtiIntro2: '12の質問に答えてMBTIタイプを発見しましょう！',
        mbtiStartBtn: 'テスト開始', mbtiRestartBtn: 'もう一度', mbtiResultTitle: 'あなたの性格タイプ',
    ...
    ms: {
        ...
        personalityTest: 'Ujian Personaliti MBTI', personalityTestDesc: 'Temui 16 jenis personaliti anda',
        mbtiTitle: '🧠 Ujian Personaliti MBTI', mbtiSubtitle: 'Temui 16 jenis personaliti anda',
        mbtiIntro1: 'MBTI (Myers-Briggs Type Indicator) adalah antara ujian personaliti yang paling popular di dunia. Ia mengkategorikan personaliti kepada 16 jenis berdasarkan empat dimensi:',
        mbtiIntro2: 'Jawab 12 soalan untuk 发现您的MBTI类型！',
        mbtiStartBtn: 'Mula Ujian', mbtiRestartBtn: 'Cuba Lagi', mbtiResultTitle: 'Jenis Personaliti Anda',
    ...
    tl: {
        ...
        personalityTest: 'MBTI Personality Test', personalityTestDesc: 'Tuklasin ang iyong 16 na uri ng personalidad',
        mbtiTitle: '🧠 MBTI Personality Test', mbtiSubtitle: 'Tuklasin ang iyong 16 na uri ng personalidad',
        mbtiIntro1: 'Ang MBTI (Myers-Briggs Type Indicator) ay isa sa mga pinakasikat na personality test sa buong mundo. Nagcategorize ito ng personality sa 16 na tipo batay sa apat na dimensyon:',
        mbtiIntro2: 'Sumagot ng 12 tanong para malaman ang iyong MBTI type!',
        mbtiStartBtn: 'Simulan ang Test', mbtiRestartBtn: 'Subukan Ulit', mbtiResultTitle: 'Iyong Personality Type',
    ...
    zh: {
        ...
        personalityTest: 'MBTI 性格测试', personalityTestDesc: '发现你的性格类型',
        mbtiTitle: '🧠 MBTI 性格测试', mbtiSubtitle: '发现你的16种性格类型',
        mbtiIntro1: 'MBTI（迈尔斯-布里格斯类型指标）是全球最流行的性格测试之一。它基于四个维度将性格分为16种类型：',
        mbtiIntro2: '回答12个问题，发现你的MBTI类型！',
        mbtiStartBtn: '开始测试', mbtiRestartBtn: '重新测试', mbtiResultTitle: '你的性格类型',
